...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LALT, KC_LALT, KC_LGUI, LOWER,   KC_BSPC, KC_ENT,  KC_SPC,  KC_RALT, KC_LBRC, KC_RBRC, KC_RIGHT
),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______,  _______, LCTRL_W, _______, LCTRL_R, LCTRL_T, KC_SLBRC,KC_SRBRC,KC_P8,   KC_P9,   KC_LBRC, KC_RBRC,
  KC_DEL,   LCTRL_A, LCTRL_S, LCTRL_D, LCTRL_F, LCTRL_G, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT,_______, _______,
  _______,  LCTRL_Z, LCTRL_X, LCTRL_C, LCTRL_V, LCTRL_B, CH_PREV_TAB,_______,_______,CH_NEXT_TAB,_______, _______,
